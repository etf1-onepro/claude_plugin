...
Conecta a sua IA aos dados e motores de análise do
[OnePro](https://etf1.com.br/onepro): ETFs BR e globais, ações, BDRs, FIIs,
fundos, renda fixa, índices, e a carteira do próprio assinante.
...
Assinatura ativa do OnePro. O conector é um benefício do assinante: não há
camada gratuita.
...
**snapshot mensal**: toda resposta traz `dataset_version`, e os motores
raciocinam em termos reais (R$ de hoje).
...
- **`onepro-conectar`** cobre a verificação da conexão e o diagnóstico de
  falha: autorização, assinatura, cota e o que fazer com o erro que a tool
  devolveu.
